...
class DVRStrategy(ABC):
    ...
    def __init__(
        ...
        # Código de verificación del equipo (el que aparece en la etiqueta y en
        # "Hik-Connect / Guarding Vision → Verification Code"). Solo hace falta
        # cuando el equipo tiene el cifrado de stream activado: sin él, la nube
        # devuelve la URL marcada como encriptada y no hay imagen.
