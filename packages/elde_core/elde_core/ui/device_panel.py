...
from ..dvr.storage                       import DVRRepository, DVRDevice
from ..dvr.connect_worker               import DVRConnectWorker
from ..dvr                                 import DVRContext, DeviceInfo
from ..dvr.hikconnect_channel_encoder     import HikConnectChannelEncoder, ChannelTypeDetector
...
class DevicePanel(QWidget):
    ...
    def _poblar_regiones(self, es_ezviz: bool) -> None:
        ...
        if es_ezviz:
            from ..dvr.ezviz import REGIONES
