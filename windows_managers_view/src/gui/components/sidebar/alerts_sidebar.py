...
_ORDER_KEYWORDS = {"toma de orden", "order", "toma_de_orden", "recepcion", "recepcion_marcador", "entrega_marcador"}
_DELIVERY_KEYWORDS = {"entrega de plato", "delivery", "entrega_de_plato", "entrega"}
